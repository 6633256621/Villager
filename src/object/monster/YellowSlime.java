...
public class YellowSlime extends Slime {
    private Image slime_jump_1 = new Image(ClassLoader.getSystemResourceAsStream("monster/slime/Yelllow/slime_jumping_1.png"));
    private Image slime_jump_2 = new Image(ClassLoader.getSystemResourceAsStream("monster/slime/Yelllow/slime_jumping_2.png"));
    private Image slime_jump_3 = new Image(ClassLoader.getSystemResourceAsStream("monster/slime/Yelllow/slime_jumping_3.png"));
    ...
    public void drawDead(GraphicsContext gc) {
        ...
        if (getDyingCounter() <= 10) {
            setDef(new Image(ClassLoader.getSystemResourceAsStream("monster/slime/Yelllow/slime_death1.png")));
        } else if (getDyingCounter() > 10 && getDyingCounter() <= 20) {
            setDef(new Image(ClassLoader.getSystemResourceAsStream("monster/slime/Yelllow/slime_death2.png")));
        } else if (getDyingCounter() > 20 && getDyingCounter() <= 30) {
            setDef(new Image(ClassLoader.getSystemResourceAsStream("monster/slime/Yelllow/slime_death3.png")));
